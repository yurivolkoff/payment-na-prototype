...
/**
 * Главная принимает ЛЮБОЙ номер лицевого счёта без проверки (демо):
 * возвращает найденный счёт с введённым номером.
 */
export function findHomeDocByAccount(account: string): PaymentDoc {
  return buildGazpromDoc(account.trim() || '101001090');
}

/** Хардкод-подсказки адреса для поля на Главной (офлайн, без внешних сервисов). */
export const ADDRESS_SUGGESTIONS: string[] = [
  'обл. Курская, г. Курск, ул. Гайдара, д. 5, кв. 48',
  'обл. Курская, г. Курск, ул. Ленина, д. 14, кв. 12',
  'обл. Курская, г. Курск, ул. Карла Маркса, д. 70, кв. 5',
  'обл. Курская, г. Курск, пр-т Победы, д. 50, кв. 101',
  'обл. Курская, г. Курск, ул. Дзержинского, д. 28, кв. 7',
  'обл. Курская, г. Железногорск, ул. Мира, д. 3, кв. 22',
  'г. Москва, ул. Тверская, д. 10, кв. 45',
  'г. Санкт-Петербург, Невский пр-т, д. 28, кв. 9',
];
